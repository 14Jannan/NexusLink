...
const universityLogos = [
  { name: 'University of Moratuwa', logoUrl: '/images/uom.png' },
  { name: 'University of Colombo', logoUrl: '/images/uoc.png' },
  { name: 'University of Peradeniya', logoUrl: '/images/uop.png' },
  { name: 'SLIIT', logoUrl: '/images/sliit.png' },
